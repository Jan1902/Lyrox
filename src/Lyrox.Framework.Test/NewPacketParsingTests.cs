...
public class NewPacketParsingTests
{
    ...
    public void Test_PrimitiveTypes()
    {
        ...
        var packet = Deserializer.Deserialize<KeepAlive>(reader);
    ...
    public void Test_CustomTypes()
    {
        ...
        using var reader = new MojangBinaryReader(stream);
        var packet = Deserializer.Deserialize<BlockUpdate>(reader);
    ...
    public void Test_Complex()
    {
        ...
        using var reader = new MojangBinaryReader(stream);
        var packet = Deserializer.Deserialize<PlayerChatMessage>(reader);
