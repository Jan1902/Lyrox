...
namespace Lyrox.Framework.Networking.Mojang
{
    public class NetworkConnection : INetworkConnection
    {
        ...
        public NetworkConnection(LyroxConfiguration lyroxConfiguration, ILogger<NetworkConnection> logger, IEventManager eventManager, INetworkPacketManager packetManager)
        {
            _streamManager = new();
